...
// ВЕРНУЛИ 31.07.2026: в темпе живого просмотра (1 сегмент / 3 сек) прошло
// 120 сегментов подряд без единой ошибки — при том, что ночью на БОЛЕЕ щадящем
// темпе (~13 запросов/мин) рвало на 67-м.
