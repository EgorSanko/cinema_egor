...
export function Navbar() {
  ...
  const navLinks = (() => {
    ...
    //
    // Вкладка «Про» убрана 14.09.2026: кинотеатр стал бесплатным, продавать
    // больше нечего — всё, что давала подписка, теперь есть у каждого. Сама
    // страница /pro осталась доступной по прямой ссылке (там история платежей),
    // но в меню её не показываем, чтобы не обещать того, чего нет.
    return links;
  })();
